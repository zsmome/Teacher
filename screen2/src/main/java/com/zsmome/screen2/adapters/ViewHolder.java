package com.zsmome.screen2.adapters;
...
public class ViewHolder {
     ...
     * @return
     */
    public ViewHolder setButtonText(int viewId,String str){
        Button but = getView(viewId);
        but.setText(str);
        return this;
    }
//
...
//     * @return
//     */
//    public ViewHolder setImageViewURL(int viewId,final String url1){
//        final ImageView view = getView(viewId);
//        //使用Piccasso
//        Picasso.with(mContext).load(url1).into(view);
//        return this;
//    }
}
